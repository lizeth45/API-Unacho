...
public class AlbumService implements IAlbumService {
	...
	// SELECCIONAR LAS CANCIONES DE UN ALBUM EN ESPECIFICO
	@Override
	public List<Canciones> consultaCancionesAlbum(Integer idAlbum) {
		// TODO Auto-generated method stub
		return repoAlbum.mostrarCancionesAlbum(idAlbum);
	}
